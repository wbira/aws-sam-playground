...
This is a sample template for sam.playground - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam.playground --query 'Stacks[].Outputs'
```
